...
export function WriteReviewDialog({
  ...
  const { createReview } = useReviews(reviewedUserId);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Share your experience with {reviewedUserName || 'this owner'}
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 justify-end">
            ...
            <Button type="submit" disabled={submitting || !rating || !ownerListingId}>
